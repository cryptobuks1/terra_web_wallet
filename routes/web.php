...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin']], function () {
    ...
    Route::post('/deposit_anchor', [App\Http\Controllers\Admin\UserViewController::class, 'deposit'])->name('user_deposit');
    Route::post('/withdraw_anchor', [App\Http\Controllers\Admin\UserViewController::class, 'withdraw'])->name('user_withdraw');
});
